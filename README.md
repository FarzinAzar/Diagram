<style>
  ...
  /* لایه‌ها */
  .l1 h3 { background: #0288d1; }
  .l2 h3 { background: #d81b60; }
  .l3 h3 { background: #388e3c; }
  .l4 h3 { background: #f57c00; }
  .l5 h3 { background: #673ab7; }
  .l6 h3 { background: #009688; }
  .l7 h3 { background: #00acc1; }

  /* باکس‌های اضافی */
  .box-tools h3 { background: #222; }
  .box-stakeholders h3 { background: #6a1b9a; }
  .box-standards h3 { background: #d84315; }
  .box-security h3 { background: #00796b; }
  .box-compliance h3 { background: #004d40; }
  .box-infra h3 { background: #512da8; }
  .box-inputs h3 { background: #8e24aa; }
  .box-outputs h3 { background: #c62828; }
    ...
    <div class="modules">
      ...
      <div class="module">
        ...
        <div class="module-details">
          ...
          <strong>ارتباطات با ماژول‌های دیگر:</strong> Interactive Dashboards, User Experience Evaluation, Cross-Platform Compatibility
        </div>
      </div>
      <div class="module">
        Signal Scoring
      ...
      <div class="module">
        ...
        <div class="module-details">
          <strong>ارتباطات با لایه‌ها:</strong> لایه‌های ۴، ۶<br>
          <strong>ارتباطات با ماژول‌های دیگر:</strong> Interactive Dashboards, Strategic Reports
        </div>
      </div>
      <div class="module">
  ...
  <div class="box box-tools">
    ...
    <div class="card-grid">
      ...
      <div class="card">
        ...
        <div class="card-desc">مرتبط با لایه‌های ۱، ۴ - ماژول‌ها: Stream Processing Engine, Real-time Alerts</div>
      </div>
      <div class="card">
  ...
  <div class="box box-standards">
    ...
    <div class="card-grid">
      ...
      <div class="card">
        ...
        <div class="card-desc">مرتبط با لایه‌های ۱، ۵ - ماژول‌ها: Data Quality Scoring, Market Data Validation</div>
      </div>
      <div class="card">
  ...
  <div class="box box-outputs">
    ...
    <div class="card-grid">
      ...
      <div class="card">
        ...
        <div class="card-desc">مرتبط با لایه‌های ۴، ۷ - ماژول‌ها: Real-time Alerts, Pattern-based Alerting</div>
      </div>
      <div class="card">
